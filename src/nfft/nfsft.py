...
#                fhat[n,k] = self._cplan.f_hat[self._N_internal-k+1,self._N_internal+n+1]
            fhat[n, -n:n] = np.flip(self._cplan.f_hat[self._N_internal-n+1:self._N_internal+n+2,self._N_internal+n+1])
        return fhat
...
#                self._cplan.f_hat[self._N_internal-k+1,self._N_internal+n+1]=fhat[n,k]
            self._cplan.f_hat[self._N_internal-n+1:self._N_internal+n+2,self._N_internal+n+1] = np.flip(fhat[n,-n:n])
